...
managerCore = node["cida-auth"]["tomcat"]["manager.core.source.war"]
managerCoreName = node["cida-auth"]["tomcat"]["manager.core.final.name"]
manager = node["cida-auth"]["tomcat"]["manager.source.war"]
managerName = node["cida-auth"]["tomcat"]["manager.final.name"]
cidaAuth = node["cida-auth"]["tomcat"]["cida.auth.source.war"]
cidaAuthName = node["cida-auth"]["tomcat"]["cida.auth.final.name"]
...
node.default["wsi_tomcat"]["instances"]["default"]["context"]["environments"] = [
	{ "name" => "development", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["development"]},
	{ "name" => "auth.ldap.url", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.ldap.url"]},
	{ "name" => "auth.ldap.domain", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.ldap.domain"]},
	{ "name" => "auth.ldap.bind.user.prefix", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.ldap.bind.user.prefix"]},
	{ "name" => "auth.ldap.bind.user.suffix", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.ldap.bind.user.suffix"]},
	{ "name" => "auth.manager.password.algorithm", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.manager.password.algorithm"]},
	{ "name" => "auth.manager.core.rest.url", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.manager.core.rest.url"]},
	{ "name" => "auth.manager.core.host", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.manager.core.host"]},
	{ "name" => "auth.manager.core.port", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.manager.core.port"]},
	{ "name" => "auth.manager.core.scheme", "type" => "java.lang.String", "override" => true, "value" => node["cida-auth"]["tomcat"]["auth.manager.core.scheme"]}
]
...
if node["cida-auth"]["tomcat"].has_key?("encrypted_environments_data_bag")
	node.default["wsi_tomcat"]["instances"]["default"]["context"]["encrypted_environments_data_bag"] = node["cida-auth"]["tomcat"]["encrypted_environments_data_bag"]
end

#Database connection
username_key = node["cida-auth"]["data_bag_username_field"]
password_key = node["cida-auth"]["data_bag_password_field"]
node.default["wsi_tomcat"]["instances"]["default"]["context"]["resources"] = [{ 
        "description" => "token storage database",
        "name" => "jdbc/cidaAuthDS",
        "auth" => "Container",
        "type" => "javax.sql.DataSource",
        "driver_class" => node["cida-auth"]["jdbc_driver_class"],
        "url" => node['cida-auth']['db_connection'],
        "max_active" => "50",
        "max_idle" => "10",
...
node.default["wsi_tomcat"]["lib_sources"] = [{
	"name" => node["cida-auth"]["jdbc_driver_filename"], 
	"url" => node["cida-auth"]["jdbc_driver_source"] 
}]
